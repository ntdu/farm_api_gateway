...
class GunicornSetting(BaseSettingMixin):
    ...
    @classmethod
    def create_gunicorn_config(cls):
        ...
        web_concurrency_str = os.getenv("GUNICORN_WORKER_CONCURRENCY", cls.GUNICORN_WORKER_CONCURRENCY)

        host = os.getenv("HOST", cls.GUNICORN_HOST)
        port = os.getenv("PORT", cls.GUNICORN_PORT)
        ...
        gconfig = {
            ...
            "errorlog": cls.GUNICORN_ERROR_LOG if cls.GUNICORN_ERROR_LOG else errorlog,
            "accesslog": cls.GUNICORN_ACCESS_LOG if cls.GUNICORN_ACCESS_LOG else accesslog,
